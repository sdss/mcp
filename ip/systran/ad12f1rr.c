...
/****************************************************************************/
/*                                                                          */
/*  Module Name: ad12f1rr                                                   */
/*                                                                          */
/*  Procedure Name(s): ADC128F1_Read_Reg                                    */
/*                                                                          */
/*  Description: This routine is used to read the ADC128F1 registers.       */
/*                                                                          */
...
int ADC128F1_Read_Reg(int path, int reg_id, u_int16 *buf) {
	...
	if(ADC128F1ReadReg16(path, reg_offset, buf) == ERROR) {
		errno = E_BUSERR;
		return(ERROR);
	}
