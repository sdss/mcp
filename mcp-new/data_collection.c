...
printf("rot_370_ccw=%d\n",sdssdc.status.i1.il4.rot_370_ccw);
printf("rot_190_cw=%d\n",sdssdc.status.i1.il4.rot_190_cw);
...
printf("alt_15_deg_stop_ext=%d\n",sdssdc.status.i7.il0.alt_15_deg_stop_ext);
...
printf("tbar_latch_stat=%d\n",sdssdc.status.i8.il0.tbar_latch_stat);
printf("alt_15_deg_stop_ret=%d\n",sdssdc.status.i8.il0.alt_15_deg_stop_ret);
...
printf("tbar_unlatch_stat=%d\n",sdssdc.status.i9.il0.tbar_unlatch_stat);
...
printf("t_bar_unlatch_pmt=%d\n",sdssdc.status.o11.ol0.t_bar_unlatch_pmt);
printf("t_bar_latch_pmt=%d\n",sdssdc.status.o11.ol0.t_bar_latch_pmt);
