    ...
    FOREVER
  {
    if (semTake (semSLCDC,WAIT_FOREVER)!=ERROR)
    {
      if (semTake (semSLC,60)!=ERROR)
      {
        ...
        stat |= slc_read_blok(1,9,0x85,224,&status[256],24);
	semGive (semSLC);
        if (stat==0)
        {
          taskLock();
          swab (&status[0],(char *)(&sdssdc.status.i1),152*2);
          taskUnlock();
        }
      }
    }
...
printf("dog_house_cls=%d\n",sdssdc.status.i56.il0.dog_house_cls);
printf("hatch_closed=%d\n",sdssdc.status.i56.il0.hatch_closed);
printf("bldg_clear=%d\n",sdssdc.status.i56.il0.bldg_clear);
printf("w_lower_stop=%d\n",sdssdc.status.i56.il0.w_lower_stop);
...
printf("n_fork_stop=%d\n",sdssdc.status.i56.il0.n_fork_stop);
printf("n_wind_stop=%d\n",sdssdc.status.i56.il0.n_wind_stop);
printf("interlock_reset=%d\n",sdssdc.status.i56.il0.interlock_reset);
printf("fiber_signal_loss=%d\n",sdssdc.status.i56.il0.fiber_signal_loss);
printf("cr_stop=%d\n",sdssdc.status.i56.il0.cr_stop);
printf("tcc_stop=%d\n",sdssdc.status.i56.il0.tcc_stop);
printf("deg_15_stop_out=%d\n",sdssdc.status.i56.il0.deg_15_stop_out);
printf("deg_15_stop_in=%d\n",sdssdc.status.i56.il0.deg_15_stop_in);
printf("az_mtr2_perm=%d\n",sdssdc.status.i56.il0.az_mtr2_perm);
printf("az_mtr1_perm=%d\n",sdssdc.status.i56.il0.az_mtr1_perm);
printf("az_mtr_ccw=%d\n",sdssdc.status.i56.il0.az_mtr_ccw);
printf("az_mtr_cw=%d\n",sdssdc.status.i56.il0.az_mtr_cw);
printf("az_plc_permit_in=%d\n",sdssdc.status.i56.il0.az_plc_permit_in);
printf("az_mtr2_rdy=%d\n",sdssdc.status.i56.il0.az_mtr2_rdy);
printf("az_mtr1_rdy=%d\n",sdssdc.status.i56.il0.az_mtr1_rdy);
printf("az_290_ccw=%d\n",sdssdc.status.i56.il0.az_290_ccw);
printf("az_290_cw=%d\n",sdssdc.status.i56.il0.az_290_cw);
printf("az_280_ccw=%d\n",sdssdc.status.i56.il0.az_280_ccw);
printf("az_280_cw=%d\n",sdssdc.status.i56.il0.az_280_cw);
printf("az_dir_ccw=%d\n",sdssdc.status.i56.il0.az_dir_ccw);
printf("az_dir_cw=%d\n",sdssdc.status.i56.il0.az_dir_cw);
...
printf("az_stow_b=%d\n",sdssdc.status.i78.il0.az_stow_b);
printf("az_stow_a=%d\n",sdssdc.status.i78.il0.az_stow_a);
printf("alt_stow=%d\n",sdssdc.status.i78.il0.alt_stow);
printf("alt_mtr2_perm=%d\n",sdssdc.status.i78.il0.alt_mtr2_perm);
printf("alt_mtr1_perm=%d\n",sdssdc.status.i78.il0.alt_mtr1_perm);
printf("alt_mtr_dn=%d\n",sdssdc.status.i78.il0.alt_mtr_dn);
printf("alt_mtr_up=%d\n",sdssdc.status.i78.il0.alt_mtr_up);
printf("alt_plc_permit_in=%d\n",sdssdc.status.i78.il0.alt_plc_permit_in);
printf("alt_mtr2_rdy=%d\n",sdssdc.status.i78.il0.alt_mtr2_rdy);
printf("alt_mtr1_rdy=%d\n",sdssdc.status.i78.il0.alt_mtr1_rdy);
printf("alt_90_5_limit=%d\n",sdssdc.status.i78.il0.alt_90_5_limit);
printf("alt_20_limit=%d\n",sdssdc.status.i78.il0.alt_20_limit);
printf("alt_0_6_limit=%d\n",sdssdc.status.i78.il0.alt_0_6_limit);
printf("s_wind_e_stop=%d\n",sdssdc.status.i78.il0.s_wind_e_stop);
printf("lift_estop_sw=%d\n",sdssdc.status.i78.il0.lift_estop_sw);
printf("lift_dn_sw=%d\n",sdssdc.status.i78.il0.lift_dn_sw);
printf("lift_up_sw=%d\n",sdssdc.status.i78.il0.lift_up_sw);
printf("deg_15_in_permit=%d\n",sdssdc.status.i78.il0.deg_15_in_permit);
printf("alt_brake_disengaged=%d\n",sdssdc.status.i78.il0.alt_brake_disengaged);
printf("rot_mtr_perm=%d\n",sdssdc.status.i78.il0.rot_mtr_perm);
printf("rot_mtr_ccw=%d\n",sdssdc.status.i78.il0.rot_mtr_ccw);
printf("rot_mtr_cw=%d\n",sdssdc.status.i78.il0.rot_mtr_cw);
printf("rot_plc_permit_in=%d\n",sdssdc.status.i78.il0.rot_plc_permit_in);
printf("rot_mtr_rdy=%d\n",sdssdc.status.i78.il0.rot_mtr_rdy);
printf("rot_290_ccw=%d\n",sdssdc.status.i78.il0.rot_290_ccw);
printf("rot_290_cw=%d\n",sdssdc.status.i78.il0.rot_290_cw);
printf("rot_dir_ccw=%d\n",sdssdc.status.i78.il0.rot_dir_ccw);
printf("rot_dir_cw=%d\n",sdssdc.status.i78.il0.rot_dir_cw);
printf("wind_dog_house_dr_cl=%d\n",sdssdc.status.o910.ol0.wind_dog_house_dr_cl);
printf("wind_alt_plc_perm=%d\n",sdssdc.status.o910.ol0.wind_alt_plc_perm);
printf("wind_az_plc_perm=%d\n",sdssdc.status.o910.ol0.wind_az_plc_perm);
printf("deg_15_stop_in_perm=%d\n",sdssdc.status.o910.ol0.deg_15_stop_in_perm);
printf("deg_15_stop_out_perm=%d\n",sdssdc.status.o910.ol0.deg_15_stop_out_perm);
printf("rot_plc_ccw_perm=%d\n",sdssdc.status.o910.ol0.rot_plc_ccw_perm);
printf("rot_plc_cw_perm=%d\n",sdssdc.status.o910.ol0.rot_plc_cw_perm);
printf("rot_plc_perm=%d\n",sdssdc.status.o910.ol0.rot_plc_perm);
printf("alt_plc_dn_perm=%d\n",sdssdc.status.o910.ol0.alt_plc_dn_perm);
printf("alt_plc_up_perm=%d\n",sdssdc.status.o910.ol0.alt_plc_up_perm);
printf("alt_plc_perm=%d\n",sdssdc.status.o910.ol0.alt_plc_perm);
printf("az_plc_ccw_perm=%d\n",sdssdc.status.o910.ol0.az_plc_ccw_perm);
printf("az_plc_cw_perm=%d\n",sdssdc.status.o910.ol0.az_plc_cw_perm);
printf("az_plc_perm=%d\n",sdssdc.status.o910.ol0.az_plc_perm);
printf("umbilical_dir_cmd=%d\n",sdssdc.status.o910.ol0.umbilical_dir_cmd);
printf("umbilical_motor_cmd=%d\n",sdssdc.status.o910.ol0.umbilical_motor_cmd);
...
printf("solenoid_enable=%d\n",sdssdc.status.o910.ol0.solenoid_enable);
printf("pump_on_cmd=%d\n",sdssdc.status.o910.ol0.pump_on_cmd);
printf("lift_estop_light=%d\n",sdssdc.status.o910.ol0.lift_estop_light);
printf("lift_dn_light=%d\n",sdssdc.status.o910.ol0.lift_dn_light);
printf("lift_up_light=%d\n",sdssdc.status.o910.ol0.lift_up_light);
...
printf("umbilical_strain_sw=%d\n",sdssdc.status.i11o12.ol0.umbilical_strain_sw);
printf("tbar_latch_cls_perm=%d\n",sdssdc.status.i11o12.ol0.tbar_latch_cls_perm);
printf("tbar_latch_opn_perm=%d\n",sdssdc.status.i11o12.ol0.tbar_latch_opn_perm);
}
#ifdef NOTDEFINED
long tstmem[300];
test_avail_transfer()
